...
{
    private static final java.lang.String TAG = "OpenCVLoader/BaseLoaderCallback";

    private Camera camera;
    private SurfaceHolder surfaceHolder;
    private SurfaceView preview;
    private Button shotBtn;
    private JavaCameraView cvCameraView;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* cvCameraView = (JavaCameraView) findViewById(R.id.CameraActivityView);
       ...
       // shotBtn.setX((getWindow().getDecorView().getWidth() - shotBtn.getWidth()) / 2);
