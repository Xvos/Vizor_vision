...
//color_t color_fromComponents(u32 R, u32 G, u32 B)
//{
//    color_t newColor;
//
//    newColor.R = R;
...
//    color->A = ((abgrColor >> 24) & 0x000000FF);
//
//    //"unmultiplied": color = (255 * color) / alpha.
//    color->B = (((abgrColor >> 16) & 0x000000FF) * 255) / color->A;
//    color->G = (((abgrColor >>  8) & 0x000000FF) * 255) / color->A;
//    color->R = ((abgrColor & 0x000000FF) * 255) / color->A;
//}
//
...
//
//    *abgrColor =
//            ((color->A & 0xFF) << 24) & 0xFF000000 |
//            ((color->B & 0xFF) << 16) & 0x00FF0000 |
//            ((color->G & 0xFF) <<  8) & 0x0000FF00 |
//            (color->R & 0xFF) & 0x000000FF;
//}
